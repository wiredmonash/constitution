...
(a) 14 days notice of the intention to move a motion of rejection has been served on the person, Club members and the C&S Executive, and 
(b) they have been given a reasonable opportunity to speak to the motion.
...
(a) the amount of the annual membership fee (if any); and
(b) ensure differential pricing is charged, as outlined in the C&S Finance Regulations.
(2) Subject to subrule (1) (b) any new member who joins after 1 July may pay a fee that is a proportion of the full annual membership fee, as determined by the Committee. 
...
(a) they are a member of at least 7 days standing; and
...
(a) to receive notice of general meetings and of proposed changes to this constitution and other matters in the manner and time prescribed by this constitution; and
(b) to submit items of business for consideration at a general meeting; and
(c) to attend and be heard at general meetings; and
(d) to stand for election to the Committee and be a committee member; and
(e) to have access to the minutes of general meetings, committee meetings and other documents of the Club as provided under rule 76; and
(f) on request to the Secretary, to inspect the register of all Club members, as prescribed under rule 19(4).
...
(a) the member’s membership fee is not paid by 20 March; or
(b) where no annual subscription is payable, the member has not re-registered by 20 March.
...
(b) the member’s Monash student ID number (if applicable);
(c) the member’s email address;
(d) the member’s home campus;
(e) the date of becoming a member;
(f) if the member is an ordinary, associate or honorary life member; and
(g) any other information determined by the Committee.
...
(a) may be committee members, members of the Club or anyone else, provided they are students; but 
...
(c) specifying the date, place (which must be on the Clayton Campus) and time of the meeting at which the disciplinary subcommittee intends to consider the disciplinary action (the disciplinary meeting); and
(d) advising the member that they may do one or more of the following—
...
(e) advising the member that they can be accompanied by one person who may provide assistance, support or both, who may be—
(i) a counsellor;
(ii) a Monash student or staff member; or
(iii) a family member; but—
may not be accompanied or assisted by anyone who is legally qualified; and
(f) setting out the member’s appeal rights under rule 24.
(2) The notice must be given no later than—
(a) 14 days, if held on an academic day; or
(b) 28 days, otherwise—
...
(c) suspend the membership rights of the member for a specified period, including the right to stand for election and be a committee member; or
...
(b) to the Secretary no later than 48 hours after the vote.
...
(a) specify the date and time of the meeting, which must be held on an academic day; and
(b) state—
...
(a) If a quorum is not present within 20 minutes after the notified commencement time of a disciplinary appeal meeting—
(i) the disciplinary appeal meeting must be adjourned to an academic day no fewer than 5 and at most 10 academic days after the adjournment; and
(ii) notice of the date, time and place to which the meeting is adjourned must be confirmed by notice given to the person appealing the decision of the disciplinary subcommittee, C&S Executive and to each ordinary member of the Club who is entitled to vote as soon as practicable after the meeting; and—
(b) If a quorum is not present within 20 minutes after the time to which a disciplinary appeal meeting has been adjourned under subrule (2)(a), the ordinary members present at the meeting (if not fewer than 10) may proceed with the business of the meeting as if a quorum were present.
...
(i) elected by and from the attendants; and
(ii) who is not a committee member; and
(iii) who is not the person who is appealing the decision of the disciplinary subcommittee—
shall preside as chair for the duration of the disciplinary appeal meeting; and
(c) the Committee must state the grounds for suspending or expelling the member and the reasons for taking that action; and
(d) the person whose membership has been suspended or who has been expelled must be given an opportunity to be heard.
...
(b) in the absence of agreement, a person appointed by the C&S Executive.
...
(a) to confirm the minutes of the previous annual general meeting and of any general meetings held since then;
(b) to receive and consider annual reports required under rule 47; and
...
(a) to receive and consider the President and Treasurer reports and an update on the current activities of the Club; and
(b) to provide a forum for members to give suggestions on Club activities and events.
...
(a) must be held within 30 academic days after the date on which the original request was made; and
...
(c) include any other information as required by this constitution; and
...
(a) in writing and signed by the member making the appointment on a form approved by the Committee; or 
(b) made by giving notice from the member’s registered student email account.
...
(a) state that an ordinary member may appoint another ordinary member as a proxy for the meeting; and
...
(a) in the case of a meeting convened by the C&S Executive at the request of the members under rule 34—the meeting must be dissolved; or
...
(b) in any other case—
(i) the meeting must be adjourned to an academic day no fewer than 5 and at most 10 academic days after the adjournment; and
(ii) notice of the date, time and place to which the meeting is adjourned must be confirmed by notice given to all members as soon as practicable after the meeting.
(4) If a quorum is not present within 20 minutes after the time to which a general meeting has been adjourned under subrule (3)(b), the ordinary members present at the meeting (if not fewer than 10) may proceed with the business of the meeting as if a quorum were present.
...
(a) subject to subrule (3), each ordinary member who is entitled to vote, excluding than the Chairperson, has one vote; and
(b) ordinary members may vote personally or by proxy; and
(c) unless otherwise specified in this constitution, the question must be decided on a majority of votes.
...
(a) the secret ballot must be taken at the meeting in the manner determined by the Chairperson of the meeting; and
(b) the Chairperson must declare the result of the resolution on the basis of the secret ballot.
...
(b) proxy list given to the Chairperson of the meeting under rule 36(5); and
(c) the business considered at the meeting; and
(d) any resolution on which a vote is taken and the result of the vote; and
(e) the results of any elections held; and
(f) annual reports required under rule 47.
PART 5  — COMMITTEE
...
(b) the power to approve expenditure; or
(c) a duty imposed on the Committee by this constitution and the C&S Constitution and Regulations.
...
(c) a Treasurer; and
(d) a Secretary; and
(e) an Industry Officer; and
(f) a Marketing Officer; and
(g) an Education Officer; and
(h) 3 Activities Officers; and
(i) 3 General Representatives elected under rule 53.
46 General Duties
...
(a) honestly and in good faith in the best interests of the Club; and
...
(iv) approve and sign off on all off-campus event documentation requirements, as determined by the C&S Executive;
(v) represent the Club, and act as its spokesperson, to the Clubs & Societies Council, MSA, the University and other bodies, as appropriate;
(vi) submit reports to committee meetings, as appropriate; and
(vii) submit an annual report to the AGM and a general report as required under rule 32A(2)(a).
(2) Vice President
(a) The duties of the Vice President shall be to— 
...
(iii) assist the President in their duties;
(iv) hold the diversity portfolio, that is to act as the voice of equal opportunity and diversity on all decisions and at all club events;
(v) liaise, collaborate, and maintain contact with staff of the Engineering and IT faculties;
(vi) liaise, collaborate, and maintain contact with similar student groups, and the greater IT industry to promote diversity to members and the wider student body;
(vii) perform the duties of the President if that office is vacant; and
(viii) perform other duties, as the Committee may resolve.
(3) Treasurer
(a) The duties of the Treasurer shall be to—
(i) attend committee meetings and general meetings; 
(ii) keep the Club’s financial records in order;
(iii) prepare a Club budget, at least every 6 months;
(iv) submit an annual report to the AGM and a general report as required under rule 32A(2)(a);
(v) receive all monies paid to or received by the Club and ensure receipts are issued for those monies in the name of the Club; 
(vi) ensure that all monies received are paid into the account of the Club within 2 working days after receipt, unless otherwise approved by the C&S Executive; 
(vii) make any payments authorised by the Committee or by a general meeting of the Club from the Club’s funds; 
(viii) ensure cheques are signed by at least 2 of the President, Vice President, Secretary or Treasurer; and
(ix) liaise with Clubs & Societies Council on any financial requirements.
(b) The Treasurer must—
(i) ensure that the financial records of the Club are kept in accordance with the C&S Finance Regulations; and
(ii) prepare the Club’s financial books for audit, semi-annually; 
(c) The Treasurer must ensure that at least one other committee member has access to the accounts and financial records of the Club.
(4) Secretary
(a) The Secretary must give to the C&S Executive notice of their appointment within 14 days after the appointment.
...
(iii) act as Returning Officer for Club elections, unless the Committee resolves otherwise;
(iv) ensure that an up-to-date membership register is maintained, in accordance with rule 19;
...
(5) Industry Officer
(a) The duties of the Industry Officer shall be to—
(i) attend committee meetings and general meetings;
(ii) organise sponsorship for the club and events using C&S sponsorship agreement templates, and ensure all sponsorship activities are met;
(iii) connect the club and students with the IT industry and professional bodies;
(iv) liaise with the Activities Officer, and other relevant committee members with the organisation of industry-related events; and

(v)  perform such duties as the Committee may resolve.
(6) Marketing Officer
(a) The duties of the Marketing Officer shall be to—
(i) attend committee meetings and general meetings; 
(ii) design and manage marketing and promotional material for the club’s events and activities;
(iii) manage the social media accounts of the club; and
(iv) perform such duties as the Committee may resolve.
(7) Education Officer
(a) The duties of the Education Officer shall be to—
(i) attend committee meetings and general meetings;
(ii) liaise with the Faculty of IT and other entities as appropriate to ensure adequate representation of student concerns and feedback; and
(iii) perform such duties as the Committee may resolve.  
(8) Activities Officer
(a) The duties of the Activities Officer shall be to—
(i) attend committee meetings and general meetings; 
(ii) organise and implement club events and activities;
(iii) liaise with the Industry Officer and assist with the organisation of industry events; and
(iv) perform such duties as the Committee may resolve.
(9) General Representative
(a) The duties of the General Representative shall be to—
(i) attend committee meetings and general meetings; and
...
(a) can be held by ordinary members and associate members; and
(b) should be codified within a policy or regulation as a schedule to this constitution under rule 79. 
...
(a) is an ordinary member entitled to vote under rule 12(2), and
(b) is a Clayton student, and
(c) is undertaking at least one unit of study at a Victorian campus of the University, and
(d) has not had their membership rights suspended; and
(e) is 18 years or older on the date they would take office.
...
(2) Where quorum is not present, the Chairperson must adjourn the meeting under rule 38(3)(b).
Note: Where quorum is not present at the annual general meeting adjourned under rule 38(3)(b), the meeting may proceed if quorum was present under rule 38(4).
52 Nominations
...
(a) be nominated and seconded by ordinary members who are entitled to vote at a general meeting; and
...
(a) At the annual general meeting, separate elections must be held for each of the following positions—
(i) President;
(ii) Vice-President;
(iii) Treasurer;
(iv) Secretary;
(v) Industry Officer;
(vi) Marketing Officer; 
(vii) Education Officer.
(b) If only one member is nominated for the position, the Returning Officer of the meeting must declare the member elected to the position.
(c) If more than one member is nominated, a ballot must be held in accordance with rule 54.
(2) Elections for positions where there are multiple office holders.
(a) At the annual general meeting, separate elections must be held for each of the following positions—
(i) Activities Officer(s); and
(ii) General Representative(s).
(b) If the number of members nominated for the position of ordinary committee member is less than or equal to the number to be elected, the Returning Officer of the meeting must declare each of those members to be elected to the position.
(c) If the number of members nominated exceeds the number to be elected, a secret ballot must be held in accordance with rule 54.
...
(a) Each ordinary member entitled to vote present in person; and
(b) each proxy appointed by an ordinary member entitled to vote.
...
(6) Ballot papers that do not comply with subrule (5)(b) are not to be counted.
...
(a) conduct a further election for the position in accordance with subrules (2) to (8) to decide which of those candidates is to be elected; or
...
(a) cease to be a student enrolled in a course of study administered at the Clayton campus; 
(b) are not enrolled in any units of study at a Victorian campus of the University;
(c) cease to be a member of the Club; or
(d) fail to attend 3 consecutive committee meetings (other than special or urgent committee meetings) without leave of absence under rule 69.
...
(a) 14 days notice of the intention to move a motion of removal from office has been served on the committee member, members of the Club and the C&S Executive; and
(b) the committee member has been given a reasonable opportunity to speak to the motion; and—
(c) may elect an eligible ordinary member of the Club to fill the vacant position in accordance with this Division.
58 Co-option
...
(a) in the case of a special or urgent meeting—the meeting lapses;
(b) in any other case—the meeting must be adjourned to a date no later than 14 days after the adjournment and notice of the time, date and place to which the meeting is adjourned must be given in accordance with rule 61.
66 Voting
...
(a) the full names of the members, and their positions (if applicable) in attendance at the meeting;
(b) the meeting number, venue, commencement and close time;
(c) the business considered at the meeting;
(d) any resolution on which a vote is taken and the result of the vote;
(e) any material personal interest disclosed under rule 67.
69 Leave of absence
...
(a) the financial records for the current audit period; and
...
(b) timely submission and adherence to due dates.
...
(d) by email to the Club’s official C&S email account.
76 Custody and inspection of books and records
(1) Members may on request inspect free of charge—
(a) the register of members, subject to rule 19(3);
(b) the minutes of general meetings and committee meetings;
(c) subject to subrule (2), the financial records, books, securities and any other relevant document of the Club.
...
(d) records and documents relating to transactions, dealings, activities or assets of the Club.
77 Assets
...
(a) the C&S Executive has first approved the sought amendment(s); and
(b) 14 days notice of the proposed amendment is served on all Club members.
???????????????
